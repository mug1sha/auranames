        ...
        <div className="relative z-10 w-full max-w-lg aspect-square">
          ...
          >
            ...
            <div className="text-center p-8 relative z-10">
              ...
              <div className="text-2xl font-bold text-foreground mb-2 font-[family-name:var(--font-playfair)]">AuraNames</div>
          ...
          <div className="navbar-clay-pill p-8 md:p-10">
            ...
            <div className="space-y-4">
              <motion.button
                ...
                className="w-full py-4 clay-button flex items-center justify-center gap-3 text-foreground font-bold"
              >
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  type="submit"
                  className="w-full py-4 clay-button-gold text-[#0A192F] font-bold"
                >
